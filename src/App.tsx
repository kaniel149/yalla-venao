...
function PortalSwitcher() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed left-3 z-[9999] rounded-2xl shadow-2xl p-2 w-48"
          style={{ bottom: '160px', background: 'rgba(255,255,255,0.97)', backdropFilter: 'blur(12px)', border: '1px solid rgba(0,0,0,0.08)' }}
        >
